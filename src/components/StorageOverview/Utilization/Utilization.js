...
import { getUtilizationVectorTime } from '../../../selectors';
...
import { getUtilizationVectorStats } from '../../../selectors/prometheus/storage';
...
export class Utilization extends React.PureComponent {
  ...
  changeMetricDuration = newVal => {
    this.setState({ duration: newVal }, this.getCurrentMetric);
  };
  ...
  getCurrentMetric = () => {
    switch (this.state.duration) {
      case ONE_HR:
        return this.calculateMetricDetails(
          this.props.throughputUtilizationForOneHr,
          this.props.recoveryRateUtilizationForOneHr,
          this.props.iopsUtilizationForOneHr,
          this.props.latencyUtilizationForOneHr
        );

      case SIX_HR:
        return this.calculateMetricDetails(
          this.props.throughputUtilizationForSixHr,
          this.props.recoveryRateUtilizationForSixHr,
          this.props.iopsUtilizationForSixHr,
          this.props.latencyUtilizationForSixHr
        );

      case TWENTY_FOUR_HR:
        return this.calculateMetricDetails(
          this.props.throughputUtilizationForTwentyFourHr,
          this.props.recoveryRateUtilizationForTwentyFourHr,
          this.props.iopsUtilizationForTwentyFourHr,
          this.props.latencyUtilizationForTwentyFourHr
        );
...
Utilization.propTypes = {
  iopsUtilizationForOneHr: PropTypes.array,
  iopsUtilizationForSixHr: PropTypes.array,
  iopsUtilizationForTwentyFourHr: PropTypes.array,
  latencyUtilizationForOneHr: PropTypes.array,
  latencyUtilizationForSixHr: PropTypes.array,
  latencyUtilizationForTwentyFourHr: PropTypes.array,
  throughputUtilizationForOneHr: PropTypes.array,
  throughputUtilizationForSixHr: PropTypes.array,
  throughputUtilizationForTwentyFourHr: PropTypes.array,
  recoveryRateUtilizationForOneHr: PropTypes.array,
  recoveryRateUtilizationForSixHr: PropTypes.array,
  recoveryRateUtilizationForTwentyFourHr: PropTypes.array,
